...
Write-Host "Witcher 2 Save File For    $staticPercentage = [math]::Round(($staticBytes / 32) * 100, 1)
    Write-Host ""
...
Write-Host "   4. Use this data to implement real parser logic" -ForegroundColor White-ForegroundColor Green
